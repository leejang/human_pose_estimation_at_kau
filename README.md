...
We use the original source code as our baseline and our starting point, then start to modify the code to get more robust human pose in noisy and wild environment.
